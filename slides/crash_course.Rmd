...
`# Utilizar <- e = es 'casi' equivalente`

--

`# Al utilizar = se crea un duplicado en la memoria`

--

`# Te da igual si trabajas con pocos megas de datos`

--

`# Procura utilizar <- algún día vas a estar trabajando con gigas de datos`
